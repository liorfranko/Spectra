"""Stage 5 tests for /spectra:tasks command.

This module contains end-to-end tests that verify the /spectra:tasks
...
@pytest.mark.e2e
@pytest.mark.stage(5)
class TestSpectraTasks:
    """Test class for /spectra:tasks command functionality.
    ...
    def test_01_tasks_runs_successfully(self, claude_runner: ClaudeRunner) -> None:
        """Test that /spectra:tasks command executes successfully.

        This test runs the /spectra:tasks command on the feature plan
        ...
        """
        prompt = (
            "/spectra:tasks now. Do not ask for confirmation - just run it."
        )
        ...
        assert result.success, (
            f"/spectra:tasks command failed.\n"
    ...
    def test_02_tasks_file_created(
        ...
        The /spectra:tasks command should create a tasks.md file within
        ...
        assert tasks_file is not None, (
            ...
            "The /spectra:tasks command should create this file."
        )
    ...
    def test_03_tasks_has_checkboxes(
        ...
        The /spectra:tasks command should generate a tasks.md file that
        ...
        assert checkbox_count >= 1, (
            ...
            "The /spectra:tasks command should generate actionable tasks with checkboxes."
        )
    ...
    def test_04_tasks_has_phases(
        ...
        The /spectra:tasks command should organize tasks into phases
