"""Stage 4 tests for /spectra:plan command.

This module contains end-to-end tests that verify the /spectra:plan
...
@pytest.mark.e2e
@pytest.mark.stage(4)
class TestSpectraPlan:
    """Test class for /spectra:plan command functionality.
    ...
    def test_01_plan_runs_successfully(self, claude_runner: ClaudeRunner) -> None:
        """Test that /spectra:plan command executes successfully.

        This test runs the /spectra:plan command on the feature spec
        ...
        """
        prompt = (
            "/spectra:plan now. Do not ask for confirmation - just run it."
        )
    ...
    def test_02_plan_file_created(
        ...
        The /spectra:plan command should create a plan.md file within
        ...
        assert plan_file is not None, (
            ...
            "The /spectra:plan command should create this file."
        )
    ...
    def test_03_plan_has_technical_context(
        ...
        The /spectra:plan command should generate a plan.md file that
