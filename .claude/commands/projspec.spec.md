...
Reads `brief.md` and creates a structured `spec.md` with user stories, requirements, and acceptance criteria.
...
- `/projspec.new` - Create a new spec (previous step)
- `/projspec.plan` - Create implementation plan (next step)
