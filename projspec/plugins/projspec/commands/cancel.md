...
Then run `/projspec:cancel` again.
```
**STOP execution.**
...
# Cancel with reason
/projspec:cancel --reason "Requirements changed, no longer needed"

# Force cancel without prompts
/projspec:cancel --force

# Cancel with reason and delete spec
/projspec:cancel --delete --reason "Superseded by feature 015"
```
